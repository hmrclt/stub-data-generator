...
personName: org.scalacheck.Gen[String] = org.scalacheck.Gen$$anon$3@4c7e97d5

scala> personName.sample.foreach(println)
adkMjqjakfbvziswAOqxywgbTpdmfhwdmlapbpgrjbKqihahfvvykftank
```
...
personNames: org.scalacheck.Gen[String] = org.scalacheck.Gen$$anon$3@1ad1f1ef

scala> personNames.sample.foreach(println)
vJuyrdiQucnafnBQtlligwauv
```
...
names: org.scalacheck.Gen[String] = org.scalacheck.Gen$$anon$3@370ee270
...
scala> val names = Gen.forename
names: org.scalacheck.Gen[String] = org.scalacheck.Gen$$anon$3@6153420e
...
scala> val names = Gen.forename
names: org.scalacheck.Gen[String] = org.scalacheck.Gen$$anon$3@4af66c9
...
randomNames: scala.collection.immutable.IndexedSeq[String] = Vector(Liam, Isabella, Aaliyah, Riley, Eli)

scala> val moreRandomNames = (1 to 5).map{x => names.sample.get}
moreRandomNames: scala.collection.immutable.IndexedSeq[String] = Vector(Kaylee, Riley, Aiden, Nicholas, Aaliyah)
```
